...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $transactionData = [
            ...
            [
                'id' => 1, 'user_id' => 4, 'staff_id' => 1, 'date' => now()->subDays(15), 'note' => 'Setoran awal rutin',
                'details' => [
            ...
            [
                'id' => 2, 'user_id' => 5, 'staff_id' => 1, 'date' => now()->subDays(12), 'note' => 'Pembersihan kantor',
                'details' => [
            ...
            [
                'id' => 3, 'user_id' => 6, 'staff_id' => 1, 'date' => now()->subDays(8), 'note' => 'Setoran warga RT 01',
                'details' => [
            ...
            [
                'id' => 4, 'user_id' => 7, 'staff_id' => 1, 'date' => now()->subDays(5), 'note' => 'Sampah rumah tangga',
                'details' => [
            ...
            [
                'id' => 5, 'user_id' => 4, 'staff_id' => 1, 'date' => now()->subDays(2), 'note' => 'Tambahan kardus pindahan',
                'details' => [
            ...
            [
                'id' => 6, 'user_id' => 5, 'staff_id' => 1, 'date' => now()->subHours(5), 'note' => 'Setoran harian',
                'details' => [
